              ...
              <div className="p-4 sm:p-5 flex flex-col justify-between flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 btn-whatsapp font-bold px-3 sm:px-5 py-2.5 rounded-full text-xs sm:text-sm transition-all active:scale-95 whitespace-nowrap"
                  >
