...
import { Globe, Smartphone, TrendingUp, Clock, Star, Zap, Shield, Award, Users, Target, CheckCircle, Sparkles } from "lucide-react";
import type { NicheWhyPoint, NicheLabels } from "@/types/niche";
...
const iconMap: Record<string, React.ElementType> = {
  ...
  target: Target, check: CheckCircle, sparkles: Sparkles,
};
...
const NicheWhySection = ({ points, labels }: NicheWhySectionProps) => {
  return (
