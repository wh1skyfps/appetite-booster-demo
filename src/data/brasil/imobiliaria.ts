...
export const imobiliariaConfig: NicheConfig = {
  ...
  products: [
    ...
    { name: "Casa em Condomínio", desc: "Casa de 5 suítes em condomínio fechado com área gourmet e piscina.", price: "1.9M", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80" },
    { name: "Apartamento Alto Padrão", desc: "3 suítes, varanda gourmet, 3 vagas. Prédio com lazer completo.", price: "1.2M", image: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=600&q=80" },
    ...
    { name: "Mansão Alphaville", desc: "Mansão de 800m² em terreno de 2000m² com cinema e spa.", price: "4.5M", image: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&q=80", tag: "Exclusivo" },
  ...
  testimonials: [
    { name: "Carlos Eduardo", text: "Encontraram nosso apartamento ideal em apenas 2 semanas. Incríveis!", role: "Comprador" },
    { name: "Daniela Fonseca", text: "Venderam nosso imóvel acima do valor pedido. Marketing impecável.", role: "Vendedora" },
    { name: "Paulo Henrique", text: "Melhor experiência imobiliária que já tivemos. Serviço de luxo.", role: "Investidor" },
  ],
  ...
  footerTagline: "Onde luxo encontra estilo de vida.", currency: "R$", backPath: "/brasil", labels: br,
};
