...
export const clinicaPremiumConfig: NicheConfig = {
  ...
  theme: { primary: "175 55% 35%", primaryForeground: "0 0% 100%", accent: "175 30% 90%", heroOverlay: "linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0.6))", sectionDark: "175 25% 10%", sectionDarkForeground: "0 0% 95%" },
  categories: [
  ...
  products: [
    ...
    { name: "Consulta Cardiológica", desc: "Avaliação cardíaca completa com eletrocardiograma e teste ergométrico.", price: "450", image: "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=600&q=80" },
  ...
  footerTagline: "Medicina de excelência com atendimento humano.", currency: "R$", backPath: "/brasil", labels: br,
};
