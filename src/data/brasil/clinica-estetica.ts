...
const br = { navServices: "Serviços", navAbout: "Sobre", navContact: "Contato", navCta: "Agendar", heroCtaPrimary: "Nossos Serviços", heroCtaSecondary: "Agendar Agora", servicesTitle: "Nossos", servicesHighlight: "Serviços", servicesSubtitle: "Soluções premium pensadas para o seu negócio.", servicesCta: "Agendar", whyTitle: "Por que ter um", whyHighlight: "site premium", whySubtitle: "Mais que um site — uma máquina de vendas.", testimonialsTitle: "O que dizem nossos", testimonialsHighlight: "clientes", locationTitle: "Onde", locationHighlight: "estamos", ctaButtonLabel: "Fale Conosco", backLabel: "Voltar às Demos" };
export const clinicaEsteticaConfig: NicheConfig = {
  ...
  heroStyle: "editorial", cardStyle: "soft",
  theme: { primary: "340 75% 55%", primaryForeground: "0 0% 100%", accent: "340 50% 92%", heroOverlay: "linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0.6))", sectionDark: "340 25% 12%", sectionDarkForeground: "0 0% 95%" },
  categories: [
  ...
  footerTagline: "Beleza com ciência e sofisticação.", currency: "R$", backPath: "/brasil", labels: br,
};
