...
export const hairSalonEnContent: HairSalonContent = {
  ...
  heroSlides: [
    { image: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=1200&q=80", title: "Braid-Less Sew In", subtitle: "Beaded Weft", pieces: "Two Rows", price: "$795", regularPrice: "$815", detail: "Hair and Install Included" },
    { image: "https://images.unsplash.com/photo-1492106087820-71f1a00d2b11?w=1200&q=80", title: "Keratin Fusion", subtitle: "100 Pieces · 20\"", price: "$1,090", regularPrice: "$1,280", detail: "Hair and Install Included" },
    { image: "https://images.unsplash.com/photo-1519699047748-de8e457a634e?w=1200&q=80", title: "Micro Beads", subtitle: "100 Pieces · 20\"", price: "$1,090", regularPrice: "$1,280", detail: "Hair and Install Included" },
    { image: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=1200&q=80", title: "Tape-In Extensions", subtitle: "40 Pieces · 20\"", price: "$685", regularPrice: "$790", detail: "Hair and Install Included" },
  ],
  nav: { services: "Services", pricing: "Pricing", results: "Results", about: "About", contact: "Contact", bookNow: "Book Now" },
  trust: [
    { icon: "sparkles", label: "Premium Extensions" }, { icon: "heart", label: "Natural Results" },
    { icon: "award", label: "12+ Years Experience" }, { icon: "shield", label: "Non-Damaging Techniques" },
    { icon: "scissors", label: "Expert Installation" }, { icon: "mapPin", label: "Coral Gables, Miami" },
  ],
  about: {
    subtitle: "Our Story", title: "Where Beauty Becomes", titleItalic: "Art",
    paragraphs: [
      ...
      "Visit our Coral Gables salon and store, where we carry an extensive collection of colors, lengths, and textures — ready for same-day transformation.",
    ],
  ...
  serviceCategories: [
    { key: "extensions", label: "Hair Extensions" }, { key: "color", label: "Color Services" }, { key: "treatment", label: "Treatments" },
  ],
  servicesCarousel: [
  ...
  carouselSection: { subtitle: "Our Specialties", title: "Signature Services" },
  beforeAfter: { subtitle: "Real Results", title: "Stunning", titleItalic: "Transformations", desc: "Every woman deserves to feel extraordinary. See the life-changing results our clients experience.", cta: "Start Your Transformation" },
  whyChoose: {
    subtitle: "The Siutse Difference", title: "Why Women", titleItalic: "Choose Us",
    reasons: [
  ...
  pricing: {
    subtitle: "Investment", title: "Service Pricing",
    note: "All hair extensions services include shampoo, blow dry, extensions, installation, cut and style.",
    lengths: ['20"', '24"'],
    extensionServices: [
      { name: "Braid-Less Sew In", lengths: { '20"': [{ qty: "1 Weft", price: "$495" }, { qty: "2 Wefts", price: "$795" }, { qty: "3 Wefts", price: "$1,085" }, { qty: "4 Wefts", price: "$1,365" }, { qty: "5 Wefts", price: "$1,595" }], '24"': [{ qty: "1 Weft", price: "$570" }, { qty: "2 Wefts", price: "$955" }, { qty: "3 Wefts", price: "$1,300" }, { qty: "4 Wefts", price: "$1,640" }, { qty: "5 Wefts", price: "$1,920" }] } },
      { name: "Tape-In", lengths: { '20"': [{ qty: "20 Pieces", price: "$455" }, { qty: "40 Pieces", price: "$685" }, { qty: "60 Pieces", price: "$930" }, { qty: "80 Pieces", price: "$1,225" }, { qty: "100 Pieces", price: "$1,530" }], '24"': [{ qty: "20 Pieces", price: "$500" }, { qty: "40 Pieces", price: "$830" }, { qty: "60 Pieces", price: "$1,115" }, { qty: "80 Pieces", price: "$1,370" }, { qty: "100 Pieces", price: "$1,640" }] } },
      { name: "Micro Beads & Keratin", lengths: { '20"': [{ qty: "20 Pieces", price: "$450" }, { qty: "40 Pieces", price: "$625" }, { qty: "60 Pieces", price: "$835" }, { qty: "80 Pieces", price: "$960" }, { qty: "100 Pieces", price: "$1,090" }], '24"': [{ qty: "20 Pieces", price: "$540" }, { qty: "40 Pieces", price: "$750" }, { qty: "60 Pieces", price: "$990" }, { qty: "80 Pieces", price: "$1,150" }, { qty: "100 Pieces", price: "$1,300" }] } },
    ],
    beautyServices: [
      { category: "Highlights & Balayage", items: [{ name: "Money Piece", price: "$150 – $250" }, { name: "Partial", price: "$250 – $350" }, { name: "Half", price: "$350 – $500" }, { name: "Full", price: "$500 – $700" }] },
      { category: "Hair Coloring", items: [{ name: "Single Process", price: "$105 – $185" }, { name: "Toner", price: "$105 – $250" }, { name: "Full Color", price: "$150 – $300" }] },
      { category: "Smoothing Treatments", items: [{ name: "Hair Botox", price: "$150 – $350" }, { name: "Deep Hair Treatment", price: "$85 – $120" }, { name: "Keratin Treatment", price: "$250 – $450" }] },
    ],
    beautyTitle: "Color & Treatment Services",
  },
  testimonials: {
    subtitle: "Client Love", title: "What Our Clients", titleItalic: "Say", ratingText: "4.9 out of 5 · Based on 1,000+ reviews",
    items: [
  ...
  instagramHandle: "@siutsemiami", instagramUrl: "https://www.instagram.com/siutsemiami/",
  bookingCta: { subtitle: "Your Transformation Awaits", title: "Ready for the Hair", titleHighlight: "You've Always Wanted?", desc: "Book your personalized consultation today and discover why thousands of women trust SIUTSE for their most beautiful hair transformation.", bookBtn: "Book Appointment" },
  contact: { subtitle: "Visit Us", title: "Find Us", addressLabel: "Salon Address", parkingLabel: "Parking", phoneLabel: "Phone", emailLabel: "Email", hoursLabel: "Hours", hoursValue: ["Tuesday – Saturday", "10:30 AM – 6:00 PM"], closed: "Sunday & Monday — Closed" },
  footer: { tagline: "Miami's premier destination for luxury hair extensions and beauty transformations. Where every woman discovers her most beautiful, confident self.", backLabel: "Back to Demos", quickLinks: "Quick Links", contactLabel: "Contact", copyright: "© 2026 SIUTSE Hair Extensions. All rights reserved. Coral Gables, Miami, Florida." },
};
