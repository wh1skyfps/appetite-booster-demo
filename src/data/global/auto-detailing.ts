...
export const autoDetailingConfig: NicheConfig = {
  ...
  products: [
    ...
    { name: "Paint Protection Film", desc: "Self-healing PPF that shields your paint from rocks, scratches, and UV damage.", price: "2500", image: "https://images.unsplash.com/photo-1619405399517-d7fce0f13302?w=600&q=80", tag: "Ultimate" },
