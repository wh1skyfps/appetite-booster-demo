...
export const lawFirmConfig: NicheConfig = {
  ...
  theme: { primary: "220 60% 30%", primaryForeground: "0 0% 100%", accent: "40 60% 50%", heroOverlay: "linear-gradient(to right, rgba(10,20,40,0.85), rgba(10,20,40,0.4))", sectionDark: "220 30% 8%", sectionDarkForeground: "0 0% 95%" },
  stats: [
  ...
  processSteps: [
    { step: "1", title: "Free Consultation", desc: "Confidential evaluation of your case with zero obligation." },
    { step: "2", title: "Case Strategy", desc: "We build a tailored legal strategy for your specific situation." },
    { step: "3", title: "Aggressive Representation", desc: "Our attorneys fight for the best possible outcome." },
    { step: "4", title: "Resolution", desc: "We deliver results and keep you informed every step of the way." },
  ],
  categories: [
  ...
  products: [
    { name: "Free Consultation", desc: "Confidential case evaluation with an experienced attorney. No obligation.", price: "Free", image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&q=80", tag: "Free" },
    { name: "Personal Injury", desc: "Aggressive representation for accident victims. No fee unless we win.", price: "Contingency", image: "https://images.unsplash.com/photo-1505664194779-8beaceb93744?w=600&q=80" },
    { name: "Business Formation", desc: "LLC, corporation, and partnership formation with full legal guidance.", price: "From $1,500", image: "https://images.unsplash.com/photo-1507679799987-c73b7651e199?w=600&q=80" },
    ...
    { name: "Estate Planning", desc: "Wills, trusts, and powers of attorney to protect your family's future.", price: "From $800", image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&q=80" },
