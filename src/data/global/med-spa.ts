...
const enLabels = {
  navServices: "Services", navAbout: "About", navContact: "Contact", navCta: "Book Now",
  heroCtaPrimary: "Our Services", heroCtaSecondary: "Book Consultation",
  servicesTitle: "Our", servicesHighlight: "Services", servicesSubtitle: "Premium treatments tailored to your beauty goals.",
  servicesCta: "Book", whyTitle: "Why choose a", whyHighlight: "premium website",
  whySubtitle: "More than a website — a client acquisition engine.",
  testimonialsTitle: "What our", testimonialsHighlight: "clients say",
  locationTitle: "Find", locationHighlight: "us", ctaButtonLabel: "Book a Consultation", backLabel: "Back to Demos",
};
...
export const medSpaConfig: NicheConfig = {
  ...
  theme: { primary: "350 80% 55%", primaryForeground: "0 0% 100%", accent: "350 60% 92%", heroOverlay: "linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0.6))", sectionDark: "350 30% 12%", sectionDarkForeground: "0 0% 95%" },
  categories: [
  ...
  footerTagline: "Science-backed beauty in a luxury setting.", currency: "$", backPath: "/global", labels: enLabels,
};
